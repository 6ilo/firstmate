...
When the live owner is outside the current session's harness ancestry, the turn-end guard reports that read-only ownership conflict and lets the competing Stop end safely rather than blocking a session that cannot repair supervision.
