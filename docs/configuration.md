...
FM_SESSION_START_REEMIT_FULL=0   # 1 makes a clear or compaction context re-emit print the full digest instead of the slim default; same as bin/fm-session-start.sh --reemit --full
