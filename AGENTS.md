...
config/fleet-ledger  optional presence flag opting this home in to the default-off fleet activity ledger state/fleet-ledger.jsonl for outside tools; created and removed by `bin/fm-fleet-ledger.sh enable|disable`; LOCAL, gitignored, and not inherited; see docs/fleet-ledger.md
